...
local rank: 0, local size: 1, num. threads: 28
 ...
 *** Rap level is            2
 *** ID=001 : Cloud_Microphysics_kernel                                        T=    14.448 N=        1
 *** ID=002 : ____MP_NSW6                                                      T=    11.130 N=        1
 *** ID=003 : _kernel_partM12                                                  T=     0.858 N=        1
 *** ID=004 : _kernel_partM3                                                   T=     8.379 N=        1
 *** ID=005 : ____Precipitation                                                T=     7.924 N=        1
 *** ID=006 : CNV_rhogkin                                                      T=     0.328 N=        2
 *** ID=007 : _kernel_partM4                                                   T=     0.445 N=        1
 *** ID=008 : ____Saturation_Adjustment                                        T=     0.395 N=        1
